...
export const InitAppWorkspace = UU5.Common.VisualComponent.create({
  ...
  _initWorkspace(opt) {
    Calls.initWorkspace(opt.values).then(this._form.saveDone, this._form.saveFail);
  },
              ...
              return (
                <div>
                  ...
                  <UU5.Forms.Form
                    ...
                    onSaveDone={(opt) => {
                      const { dtoOut: jokesInstance } = opt;
                  ...
                  >
                    ...
                    {this.state.initType === "bt" ? (
                      <UU5.Forms.Text
                        ...
                        label="uuBtLocationUri"
                        value={this.state.form.uuBtLocationUri || ""}
                      />
                    ) : (
                      <UU5.Forms.Text
                        required
                        name="uuAppProfileAuthorities"
                        label="uuAppProfileAuthorities"
                        value={this.state.form.uuAppProfileAuthorities || ""}
                      />
                    )}
                    <UU5.Forms.Text
                      name="name"
                      label={this.getLsiComponent("labelName")}
                      value={this.state.form.name || "uuJokes"}
                    />
                    <UU5.Forms.SwitchSelector
                      name="state"
                    ...
                    />
                    <UU5.Forms.File name="logo" label={this.getLsiComponent("labelLogo")} placeholder="Upload file" />
